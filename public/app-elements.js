export const elements = {
  ...
  searchDocsInput: document.querySelector("#search-docs-input"),
  ...
  batchSelectAllCheckbox: document.querySelector("#batch-select-all-checkbox"),
  batchSelectedCount: document.querySelector("#batch-selected-count"),
  batchMoveButton: document.querySelector("#batch-move-button"),
  batchDeleteButton: document.querySelector("#batch-delete-button"),
  batchClearButton: document.querySelector("#batch-clear-button"),
